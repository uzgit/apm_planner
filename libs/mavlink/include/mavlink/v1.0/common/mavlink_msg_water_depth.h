...
#define MAVLINK_MSG_ID_WATER_DEPTH_CRC 218
#define MAVLINK_MSG_ID_237_CRC 218
...
#define MAVLINK_MESSAGE_INFO_WATER_DEPTH { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_water_depth_t, time_usec) }, \
         ...
         { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_water_depth_t, latitude) }, \
         { "longitude", NULL, MAVLINK_TYPE_INT32_T, 0, 16, offsetof(mavlink_water_depth_t, longitude) }, \
         { "altitude_amsl", NULL, MAVLINK_TYPE_INT32_T, 0, 20, offsetof(mavlink_water_depth_t, altitude_amsl) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_WATER_DEPTH { \
...
static inline uint16_t mavlink_msg_water_depth_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, float water_depth, int32_t latitude, int32_t longitude, int32_t altitude_amsl)
{
...
static inline void mavlink_msg_water_depth_send(mavlink_channel_t chan, uint64_t time_usec, float water_depth, int32_t latitude, int32_t longitude, int32_t altitude_amsl)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_WATER_DEPTH_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_water_depth_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, float water_depth, int32_t latitude, int32_t longitude, int32_t altitude_amsl)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline int32_t mavlink_msg_water_depth_get_latitude(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_water_depth_get_longitude(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_water_depth_get_altitude_amsl(const mavlink_message_t* msg)
{
